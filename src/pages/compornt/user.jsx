...
import { faUser, faRightFromBracket, faComment, faThumbTack, faFlag, faBell } from "@fortawesome/free-solid-svg-icons";
...
const Tap1 = () =>
{
    ...
    const alert = [
        {text : '업무 시간 시작', img : '', time : '9:00'},
        {text : '80%의 직원이 출근완료', img : '', time : '9:00'},
        {text : '김사원 출근', img : '', time : '8:56'},
        {text : '금부장 출근', img : '', time : '8:40'},
        {text : '금부장 출근', img : '', time : '8:36'},
        {text : '김대리 출근', img : '', time : '8:20'},
    ];
