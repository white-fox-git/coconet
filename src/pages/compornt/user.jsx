...
import { faUser, faRightFromBracket, faComment, faThumbTack, faFlag, faBell, faPieChart, faEnvelopeOpen, faTimeline } from "@fortawesome/free-solid-svg-icons";
...
const User = () =>
{
    ...
    // Get Server
    const message = [
        {name : '정사원', photo : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMzBfMjk0%2FMDAxNjQwODcyMDczODg5.RpYrl_pS_EehRY7sW5Hq6IgF0HIvru-8_UqhfMv1FvUg.Y36BljvjCZ7UDIN4p0RJl3IaEfmsyvFFtP77rDphvOMg.JPEG.qizzip%2FIMG_0546.JPG&type=sc960_832', message : '일은 언제 다 할 수 있어?', count : 3, id: 0}, 
        {name : '김대리', photo : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMTNfMTMz%2FMDAxNjE1NjQ3MDYyMjkx.PYbmg_2oucv5cGM0wU4XhTyta639FBdEKr8H2Jx7PPMg.0JWsbAO0nPudKit8Zhu_TDgL7egA0TD0ZdlrVLvwymsg.JPEG.espart1226%2F71f8d35728e5fb4d10b6a463e335d51b.jpg&type=sc960_832', message : '얼른 일하세요 김사원', count : 2, id : 1},
        {name : '부장님', photo : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAxNzA2MThfNzAg%2FMDAxNDk3Nzk0MTU4Njky.9KekOyD9-2yx0YeRZNL1CB6f0OoLxKhxKYvVue4GgC8g.gH1Cgn-jDDxhSpzmCRrTUzrHr4qzhFGMIIpwfwLV6G4g.JPEG.dawnrosa%2FIMG_2046.jpg&type=sc960_832', message : '하는 일은 잘 되가는거지?', count : 1, id : 2},
        {name : '금강선', photo : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTA2MTlfOTQg%2FMDAxNjI0MDk4MDcwMzIz.SDwRw_4ZjWM5zU_vH0bJUaUdKZEG1bOYpB_EYtnV3C8g.zYLTv9vuCJWYumkRgJbu0aA1kxZ9SV_GfGcKFhj0n1kg.JPEG.tjsdud1794%2F1624088301192.jpg&type=a340', message : '저는 빛 그 자체입니다.', count : 4, id : 3},
    ];
...
const Tap2 = () =>
{
    ...
    //Get Server
    const approvalData = [
        {state : '휴가', color : '#86ca89', name: '정사원',day : '2022.04.03(금)', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMzBfMjk0%2FMDAxNjQwODcyMDczODg5.RpYrl_pS_EehRY7sW5Hq6IgF0HIvru-8_UqhfMv1FvUg.Y36BljvjCZ7UDIN4p0RJl3IaEfmsyvFFtP77rDphvOMg.JPEG.qizzip%2FIMG_0546.JPG&type=sc960_832'},
        {state : '휴가', color : '#86ca89', name: '정사원',day : '2022.04.03(금)', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMzBfMjk0%2FMDAxNjQwODcyMDczODg5.RpYrl_pS_EehRY7sW5Hq6IgF0HIvru-8_UqhfMv1FvUg.Y36BljvjCZ7UDIN4p0RJl3IaEfmsyvFFtP77rDphvOMg.JPEG.qizzip%2FIMG_0546.JPG&type=sc960_832' },
        {state : '외근', color : '#9284d0', name: '정사원',day : '2022.04.03(금)', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMzBfMjk0%2FMDAxNjQwODcyMDczODg5.RpYrl_pS_EehRY7sW5Hq6IgF0HIvru-8_UqhfMv1FvUg.Y36BljvjCZ7UDIN4p0RJl3IaEfmsyvFFtP77rDphvOMg.JPEG.qizzip%2FIMG_0546.JPG&type=sc960_832' },
        {state : '외근', color : '#9284d0', name: '정사원',day : '2022.04.03(금)', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMzBfMjk0%2FMDAxNjQwODcyMDczODg5.RpYrl_pS_EehRY7sW5Hq6IgF0HIvru-8_UqhfMv1FvUg.Y36BljvjCZ7UDIN4p0RJl3IaEfmsyvFFtP77rDphvOMg.JPEG.qizzip%2FIMG_0546.JPG&type=sc960_832' },
        {state : '휴가', color : '#86ca89', name: '정사원',day : '2022.04.03(금)', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMzBfMjk0%2FMDAxNjQwODcyMDczODg5.RpYrl_pS_EehRY7sW5Hq6IgF0HIvru-8_UqhfMv1FvUg.Y36BljvjCZ7UDIN4p0RJl3IaEfmsyvFFtP77rDphvOMg.JPEG.qizzip%2FIMG_0546.JPG&type=sc960_832' },
        {state : '출장', color : '#ca86c3', name: '정사원',day : '2022.04.03(금)', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMzBfMjk0%2FMDAxNjQwODcyMDczODg5.RpYrl_pS_EehRY7sW5Hq6IgF0HIvru-8_UqhfMv1FvUg.Y36BljvjCZ7UDIN4p0RJl3IaEfmsyvFFtP77rDphvOMg.JPEG.qizzip%2FIMG_0546.JPG&type=sc960_832' },
    ];

    //Get Server
    const logData = [
        {state : '퇴근', color : '#86ca89', name: '김대리', position : '백엔드 개발', time : '오후 07:30', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMTNfMTMz%2FMDAxNjE1NjQ3MDYyMjkx.PYbmg_2oucv5cGM0wU4XhTyta639FBdEKr8H2Jx7PPMg.0JWsbAO0nPudKit8Zhu_TDgL7egA0TD0ZdlrVLvwymsg.JPEG.espart1226%2F71f8d35728e5fb4d10b6a463e335d51b.jpg&type=sc960_832' },
        {state : '퇴근', color : '#86ca89', name: '김대리', position : '백엔드 개발', time : '오후 07:30', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMTNfMTMz%2FMDAxNjE1NjQ3MDYyMjkx.PYbmg_2oucv5cGM0wU4XhTyta639FBdEKr8H2Jx7PPMg.0JWsbAO0nPudKit8Zhu_TDgL7egA0TD0ZdlrVLvwymsg.JPEG.espart1226%2F71f8d35728e5fb4d10b6a463e335d51b.jpg&type=sc960_832'},
        {state : '근무', color : '#9284d0', name: '김대리', position : '백엔드 개발', time : '오후 07:30', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMTNfMTMz%2FMDAxNjE1NjQ3MDYyMjkx.PYbmg_2oucv5cGM0wU4XhTyta639FBdEKr8H2Jx7PPMg.0JWsbAO0nPudKit8Zhu_TDgL7egA0TD0ZdlrVLvwymsg.JPEG.espart1226%2F71f8d35728e5fb4d10b6a463e335d51b.jpg&type=sc960_832' },
        {state : '근무', color : '#9284d0', name: '김대리', position : '백엔드 개발', time : '오후 07:30', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMTNfMTMz%2FMDAxNjE1NjQ3MDYyMjkx.PYbmg_2oucv5cGM0wU4XhTyta639FBdEKr8H2Jx7PPMg.0JWsbAO0nPudKit8Zhu_TDgL7egA0TD0ZdlrVLvwymsg.JPEG.espart1226%2F71f8d35728e5fb4d10b6a463e335d51b.jpg&type=sc960_832' },
        {state : '퇴근', color : '#86ca89', name: '김대리', position : '백엔드 개발', time : '오후 07:30', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMTNfMTMz%2FMDAxNjE1NjQ3MDYyMjkx.PYbmg_2oucv5cGM0wU4XhTyta639FBdEKr8H2Jx7PPMg.0JWsbAO0nPudKit8Zhu_TDgL7egA0TD0ZdlrVLvwymsg.JPEG.espart1226%2F71f8d35728e5fb4d10b6a463e335d51b.jpg&type=sc960_832' },
        {state : '외출', color : '#ca86c3', name: '김대리', position : '백엔드 개발', time : '오후 07:30', img : 'https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMTNfMTMz%2FMDAxNjE1NjQ3MDYyMjkx.PYbmg_2oucv5cGM0wU4XhTyta639FBdEKr8H2Jx7PPMg.0JWsbAO0nPudKit8Zhu_TDgL7egA0TD0ZdlrVLvwymsg.JPEG.espart1226%2F71f8d35728e5fb4d10b6a463e335d51b.jpg&type=sc960_832' },
    ];
